...
<!--                <div :class="{node: true, hasMate: treeData.mate}" >-->
                <div :class="{node: true}" >
                    <div class="person" v-if="treeData.name" @click="$emit('click-node', treeData)" >
                        ...
                        <div class="name" :class="{bcg_color_male:treeData.sex==='男',bcg_color_female:treeData.sex==='男人'}" >{{treeData.name}}</div>
                    </div>
                    <div class="person" v-if="treeData.groupName">
...
<!--                            &lt;!&ndash;                <img :src="image_url" :title="treeData.mate.name" />&ndash;&gt;-->
<!--                        </div>-->
