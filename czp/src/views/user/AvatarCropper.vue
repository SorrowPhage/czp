<template>
    <div class="avatar_box">
        <el-avatar :size="90" :src="avatar" class="avatar"  @click.native  ="dialogVisible = true" ></el-avatar>
        <el-dialog
        ...
        uploadImg(type) {
            if (type === 'base64') {
                this.$refs.cropper.getCropData((data) => {
                    this.$store.commit("CzpUser/setAvatar", data);
                    imageUpload("/czpUser/avatar",{file: this.base64toFile(data), id: this.id}).then(res =>{
                        this.$store.commit("CzpUser/setAvatar", res.data);
                        this.$message({
                            message: '修改成功',
                            showClose: true,
                            type: 'success',
